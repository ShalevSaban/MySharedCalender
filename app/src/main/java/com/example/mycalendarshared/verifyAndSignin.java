...
public class verifyAndSignin extends AppCompatActivity
{
   ...
   FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        verifiedCode=(EditText)findViewById(R.id.verifiedCode);
        ...
        verifiedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    PhoneAuthCredential credential=PhoneAuthProvider.getCredential(otpid,verifiedCode.getText().toString());
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                           startActivity(new Intent(verifyAndSignin.this, CalendarShared.class));
                           finish();
